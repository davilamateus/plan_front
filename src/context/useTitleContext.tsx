...
export const UseTitleContext =
	createContext<UseTitleContextType>(defaultContextValue);

type UseTitleContextProviderProps = {
	children: ReactNode;
};

export const UseTitleContextProvider = ({
	children,
}: UseTitleContextProviderProps) => {
	...
	return (
		<UseTitleContext.Provider value={{ state, setTitle }}>
			{children}
		</UseTitleContext.Provider>
	);
};
