        ...
        <div className="ads">
            ...
            <div className="box">
                <div className="planner-ticket-top">
                    <div>{UseGetTrip.currentCity ?? <Skeleton style={{ width: "98px", height: "10pt" }} />}</div>
                    <svg
