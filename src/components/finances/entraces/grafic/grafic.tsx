		...
		datasets: [
			{
				...
				borderColor: "#BCBCBC", // Define uma cor constante para as bordas
				borderWidth: 2, // Borda sempre visível, mesmo sem valor
				borderRadius: 16,
				...
				data:
					barData.value.length > 0
						...
						: [
								100000, 200000, 300000, 100000, 400000, 330000, 10000, 400000,
								400000, 200000, 100000, 40000, 20000,
						  ],
			},
		],
	};
