...
const ExchangeSimulation = ({
	...
	return (
		<div>
			<TitleOfSession title={"Simulador"} />
			<div className="simulation">
				<div className="simulation-input box">
					<div className="simulation-type">
						...
						<div>
							...
							>
								{currentCurrency ? (
									<>
										{currentCurrency} para {tripCurrency}
									</>
								) : (
							...
							>
								{currentCurrency ? (
									<>
										{tripCurrency} para {currentCurrency}
									</>
								) : (
									<img src="./../../../../gifs/btnloadin.gif" />
								)}{" "}
					...
					<InputMoney title="Valor" input={input} setInput={setInput} />
				</div>
