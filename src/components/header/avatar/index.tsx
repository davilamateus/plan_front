                        ...
                        <div
                            style={{
                                backgroundImage: `url(${BASE_URL}imagens/user/${
                                    UserContext.state.photo !== null ? UserContext.state.photo : "default.jpeg    "
                                }`
                            }}
                            className="avatar-photo"></div>
                        <ButtonOptions />
                    </div>
                </div>
            ) : (
